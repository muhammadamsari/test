<?php require APPROOT . '/views/inc/header.php'; ?>
  ...
  <div class="row ">
      ...
      <div class="col-md-4">
          <a class="btn btn-warning pull-right" href="<?php echo URLROOT ;?>/posts/add"><i class="fa fa-pencil"></i> Add Pelanggan</a>
      </div>
  </div>
  <?php foreach ($data['pelanggan'] as $pelanggan) : ?>
        <div class="card mb-3 mt-2">
            <div class="card-body"><h2 class="card-text"><?php echo  $pelanggan->pel_nama ;?></h2></div>
            <h3 class="card-body bg-success">
                Seri - Meteran : <?php echo  $pelanggan->pel_seri ;?> // <?php echo  $pelanggan->pel_meteran ;?>
            </h3>
            <p class="card-title bg-muted p-2 mb-3">
