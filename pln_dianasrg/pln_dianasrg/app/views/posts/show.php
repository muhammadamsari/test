<?php require APPROOT . '/views/inc/header.php'; ?>
  <div class="row ">
      <div class="col-md-4">
          <a class="btn btn-warning" href="<?php echo URLROOT ;?>/pelanggan"><i class="fa fa-backward"></i> Back</a>
      </div>
  </div>
        <div class="card mb-3 mt-2">
            ...
            <h5 class="card-body bg-success p-4 mb-2">
            ...
            <?php if($data['pelanggan']->pel_id_user == $_SESSION['user_id']) : ?>
                <div class="row">
                    <div class="col">
                        <a href="<?php echo URLROOT ;?>/posts/edit/<?php echo $data['pelanggan']->pel_id ;?>" class="btn btn-primary btn-block">Edit</a>
                    </div>
                    <div class="col">
