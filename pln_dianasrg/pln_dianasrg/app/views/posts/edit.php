        ...
        <div class="card bg-light mt-5">
            <div class="card-header card-text">
                <div class="row">
                    ...
                    <div class="col">
                        <a href="<?php echo URLROOT ;?>/posts" class="btn btn-warning pull-right"><i class="fa fa-backward"></i> Back</a>
                    </div>
            ...
            <div class="card-pel_alamat">
                <form method="post" action="<?php echo URLROOT ;?>/Posts/edit/<?php echo $data['id'] ;?>">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col">
                                <input type="submit" class="btn btn-success btn-block pull-left" value="Update Post">
                            </div>
                        </div>
                    </div>
                </form>
